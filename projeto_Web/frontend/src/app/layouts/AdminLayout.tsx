...
import { LayoutDashboard, Users, Dumbbell, UsersRound, ClipboardCheck, DollarSign, Megaphone, LogOut, Menu, X } from "lucide-react";
      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-50 bg-sidebar border-b border-sidebar-border">
        <div className="flex items-center justify-between p-4">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sidebar-foreground font-bold">Studio Funcional</span>
          </div>
          <button
